...
class SUtil
{
	...
	public static function getStorageDirectory(?force:Bool = false):String
	{
		...
		if (!FileSystem.exists(LimeSystem.applicationStorageDirectory + 'storagetype.txt'))
			File.saveContent(LimeSystem.applicationStorageDirectory + 'storagetype.txt', funkin.ClientPrefs.storageType);
...
enum abstract StorageType(String) from String to String
{
	...
	final packageNameLocal = 'com.sowy.trollengine';
	final fileLocal = 'TrollEngine';
